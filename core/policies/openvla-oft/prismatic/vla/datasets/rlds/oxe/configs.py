...
# FGManip fine-tuning datasets: all tasks share the same observation / action layout
_FGMANIP_CONFIG = {
    "image_obs_keys": {"primary": "image", "secondary": None, "wrist": None},
    "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
    "state_obs_keys": ["state"],
...
_FGMANIP_TASKS = [
    "peg_in_hole_rlds",
    "plug_charger",
    "rotate_along_2_rlds_100",
    "plug_charger_rlds_100",
    "stack_pyramid_rlds_100",
]

# for _task in _FGMANIP_TASKS:
#     OXE_DATASET_CONFIGS[f"{_task}"] = _FGMANIP_CONFIG.copy()
OXE_DATASET_CONFIGS["fgmanip_rlds"] = _FGMANIP_CONFIG.copy()
OXE_DATASET_CONFIGS["peg_in_hole_rlds"] = _FGMANIP_CONFIG.copy()
OXE_DATASET_CONFIGS["press_switch_rlds"] = _FGMANIP_CONFIG.copy()
OXE_DATASET_CONFIGS["grasp_part_rlds"] = _FGMANIP_CONFIG.copy()

OXE_DATASET_CONFIGS["rotate_along_rlds"] = _FGMANIP_CONFIG.copy()
OXE_DATASET_CONFIGS["plug_charger_rlds"] = _FGMANIP_CONFIG.copy()
OXE_DATASET_CONFIGS["stack_pyramid_rlds"] = _FGMANIP_CONFIG.copy()
OXE_DATASET_CONFIGS["put_blocks_into_boxes_rlds"] = _FGMANIP_CONFIG.copy()
OXE_DATASET_CONFIGS["assemble_i_rlds"] = _FGMANIP_CONFIG.copy()

# Compatibility aliases for converted dataset names / historical typos.
OXE_DATASET_CONFIGS["rotate_along_2_rlds_100"] = _FGMANIP_CONFIG.copy()
OXE_DATASET_CONFIGS["plug_charger_rlds_100"] = _FGMANIP_CONFIG.copy()
OXE_DATASET_CONFIGS["stack_pyramid_rlds_100"] = _FGMANIP_CONFIG.copy()
OXE_DATASET_CONFIGS["toggle_switch_rlds_100"] = _FGMANIP_CONFIG.copy()
OXE_DATASET_CONFIGS["toggle_switch_2_rlds_100"] = _FGMANIP_CONFIG.copy()
OXE_DATASET_CONFIGS["plug_chargere_rlds"] = _FGMANIP_CONFIG.copy()