...
def make_oxe_dataset_kwargs(
    ...
    _supported = [ActionEncoding.EEF_POS, ActionEncoding.EEF_R6, ActionEncoding.JOINT_POS_BIMANUAL, ActionEncoding.JOINT_POS]
    if dataset_kwargs["action_encoding"] not in _supported:
        raise ValueError(f"Cannot load `{dataset_name}`; unsupported action encoding {dataset_kwargs['action_encoding']}")
