...
# FGManip fine-tuning datasets: all tasks use the same transform
for _task in [
    "align_to_part", "draw_triangle", "grasp_part", "lid_opening",
    "peg_in_hole", "plug_charger", "press_switch", "rotate",
    "slide_along", "stand_up", "toggle_switch", "toggle_switch_table",
]:
    OXE_STANDARDIZATION_TRANSFORMS[f"{_task}_rlds"] = aloha_dataset_transform
OXE_STANDARDIZATION_TRANSFORMS["fgmanip_rlds"] = aloha_dataset_transform

# Compatibility aliases for converted dataset names / historical typos.
OXE_STANDARDIZATION_TRANSFORMS["rotate_along_rlds"] = aloha_dataset_transform
OXE_STANDARDIZATION_TRANSFORMS["stack_pyramid_rlds"] = aloha_dataset_transform
OXE_STANDARDIZATION_TRANSFORMS["put_blocks_into_boxes_rlds"] = aloha_dataset_transform
OXE_STANDARDIZATION_TRANSFORMS["assemble_i_rlds"] = aloha_dataset_transform
OXE_STANDARDIZATION_TRANSFORMS["rotate_along_2_rlds_100"] = aloha_dataset_transform
OXE_STANDARDIZATION_TRANSFORMS["plug_charger_rlds_100"] = aloha_dataset_transform
OXE_STANDARDIZATION_TRANSFORMS["stack_pyramid_rlds_100"] = aloha_dataset_transform
OXE_STANDARDIZATION_TRANSFORMS["toggle_switch_rlds_100"] = aloha_dataset_transform
OXE_STANDARDIZATION_TRANSFORMS["toggle_switch_2_rlds_100"] = aloha_dataset_transform
OXE_STANDARDIZATION_TRANSFORMS["plug_chargere_rlds"] = aloha_dataset_transform
