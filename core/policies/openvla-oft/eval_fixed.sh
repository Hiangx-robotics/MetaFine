...
set -euo pipefail
# =============================================================================
# FGManip OpenVLA-OFT evaluation (task-aware kwargs, original files untouched)
#
# Usage:
#   bash core/policies/openvla-oft/eval_fixed.sh [CHECKPOINT] [TASK] [EPISODES] [OBJECT_NAME] [PART_NAME]
#
# Examples:
#   bash core/policies/openvla-oft/eval_fixed.sh
#   bash core/policies/openvla-oft/eval_fixed.sh /path/to/ckpt peg_in_hole 10
#   bash core/policies/openvla-oft/eval_fixed.sh /path/to/ckpt grasp_part 10 3558 cap
# =============================================================================
...
if [ -n "${1:-}" ]; then
  ...
  echo "Usage: bash core/policies/openvla-oft/eval_fixed.sh /path/to/checkpoint [TASK] [EPISODES] [OBJECT_NAME] [PART_NAME]"
...
if [ -n "$TARGET_LETTER" ]; then
  LETTER_ARGS+=(--target_letter "$TARGET_LETTER")
fi
