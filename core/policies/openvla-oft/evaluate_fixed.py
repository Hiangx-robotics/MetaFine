...
OpenVLA-OFT evaluation with task-aware env kwargs and robust metrics.
"""
...
class GenerateConfig:
    ...
    """target_letter for assembling_kits_metafine_letter (M/E/T/A/F/I/N)."""
...
def eval_policy(cfg: GenerateConfig) -> None:
    ...
    if cfg.task_name in TASKS_WITH_OBJECT_PART:
        ...
        if cfg.target_letter is not None:
            env_kwargs["target_letter"] = cfg.target_letter
