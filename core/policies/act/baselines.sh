...
for demos in 100; do
  python train_rgbd.py --env-id PickCube-v1 --no_include_depth \
    --demo-path /home/robot/workspace/Skill_Demos/toggle/toggle_01/trajectory.rgb.pd_joint_delta_pos.physx_cpu.h5 \
  ...
  python train_rgbd.py --env-id toggle_switch --no_include_depth \
    --demo-path /home/robot/workspace/Skill_Demos/toggle/toggle_01/trajectory.rgb.pd_joint_delta_pos.physx_cpu.h5 \
    --control-mode "pd_joint_delta_pos" --sim-backend "physx_cuda" --num_demos 50 --max_episode_steps 500 --num_eval_envs 1 \
    --total_iters 30000 --log_freq 100 --eval_freq 10000 \
    --exp-name=act-toggle_switch-state-50_motionplanning_demos-$seed \
    --demo_type motionplanning --track \
    --num_eval_episodes 10

  /export/anaconda3/bin/python core/policies/act/train_rgbd.py \
    --env-id plug_charger --no_include_depth \
    --demo-path /nat/demos/PlugCharger-v1/motionplanning/trajectory.rgb.pd_joint_delta_pos.physx_cpu.h5 \
    --control-mode pd_joint_delta_pos --sim-backend physx_cuda --num_demos 50 --max_episode_steps 500 --num_eval_envs 1 \
    --total_iters 30000 --log_freq 100 --eval_freq 10000 \
    --exp-name act-peg_in_hole-rgb-50_motionplanning_demos-${seed:-0} \
    --demo_type motionplanning \
    --num_eval_episodes 10 --enable-dr-eval \
    --camera-pos-levels 0.03 0.06 0.12 \
    --camera-rot-levels-deg 2 6 12 \
    --light-ambient-delta-levels 0.10 0.25 0.40

  /export/anaconda3/bin/python core/policies/act/train_rgbd.py \
    --env-id peg_in_hole --no_include_depth \
    --demo-path /nat/demos/PegInsertionSide-v1/motionplanning/trajectory.rgb.pd_joint_delta_pos.physx_cpu.h5 \
    --control-mode pd_joint_delta_pos --sim-backend physx_cuda --num_demos 50 --max_episode_steps 500 --num_eval_envs 1 \
    --total_iters 30000 --log_freq 100 --eval_freq 10000 \
    --exp-name act-peg_in_hole-rgb-50_motionplanning_demos-${seed:-0} \
    --demo_type motionplanning \
  ...
  python train_rgbd.py --env-id grasp_part --no_include_depth \
    --demo-path /nat/demos/grasp_part/grasp_part_1/trajectory.rgb.pd_joint_delta_pos.physx_cpu.h5 \
    --control-mode "pd_joint_delta_pos" --sim-backend "physx_cuda" --num_demos 50 --max_episode_steps 500 --num_eval_envs 1 \
    --total_iters 30000 --log_freq 100 --eval_freq 10000 \
    --exp-name=act-toggle_switch-state-50_motionplanning_demos-$seed \
    --demo_type motionplanning --track \
    ...
    python train_rgbd.py --env-id StackPyramid-v1 --no_include_depth \
    --demo-path ~/.maniskill/demos/StackPyramid-v1/motionplanning/trajectory.rgb.pd_ee_delta_pose.physx_cpu.h5 \
    --control-mode "pd_ee_delta_pose" --sim-backend "physx_cuda" --num_demos 100 --max_episode_steps 100 --num_eval_envs 100 \
    --total_iters 30000 --log_freq 100 --eval_freq 1000 \
    --exp-name=act-StackPyramid-v1-state-100_motionplanning_demos-$seed \
    --demo_type motionplanning --track
  ...
  python train_rgbd.py --env-id PegInsertionSide-v1 --no_include_depth \
    ...
    --control-mode "pd_ee_delta_pose" --sim-backend "physx_cpu" --num_demos 100 --max_episode_steps 300 \
    --total_iters 100000 --log_freq 100 --eval_freq 5000 \
    --exp-name=act-PegInsertionSide-v1-state-${demos}_motionplanning_demos-$seed \
    --demo_type motionplanning --track
